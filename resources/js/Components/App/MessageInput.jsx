...
const MessageInput = ({ conversation = null }) => {
    ...
    const onSendClick = () => {
        ...
        if (newMessage.trim() === "" && setChosenFiles.length === 0) {
            setInputErrorMessage(
                "please Provice a message or upload attachments"
            );
            setTimeout(() => {
                setInputErrorMessage("");
            }, 3000);
        ...
        <div className="flex flex-wrap items-start border-t border-slate-700 py-3">
            ...
            <div className="order-3 xs:order-3 p-2 flex">
                <Popover className="relative">
                    <PopoverButton className="p-1 text-gray-400 hover:text-gray-300" ><FaceSmileIcon className="w-6 h-6" /></PopoverButton>
